...
| **BE-2** — Deal first-class | **Step 1 complete** (additive aggregate, inert) | Deal 10% → ~25% | CONTRACT_EXECUTED = "Deal Controlled"; Deal↔Transaction boundary; 1 Deal/Opportunity; no backfill; compatibility mandatory | Step 1 — 2026-07-27 |
| **BE-3** — Language enforced | Planned | Language 65% → — | — | — |
...
Architecture-Guided Implementation = BE-2 Step 1 (2026-07-27). M3/M4/M5 pending.
