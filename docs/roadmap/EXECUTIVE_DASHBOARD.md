...
| Commercial Intelligence (Owner/Property/Market/Portfolio) | 🟡 In progress | 1.2 | 50% (**Slice 1 LIVE in production** — Owner foundation/UI/linking/candidate review/refresh/merge. **Slice 2 Commits 2a + 2b LIVE**: Property runs on the *shared* `Observation→Signal→Projection` spine via the dispatch-only entity-projector registry, and **2b deployed the Property provenance UI + REFRESH-gated manual-refresh surface** (generalized `FieldProvenanceCard`), closing [D13](./TECHNICAL_DEBT.md); prod at **11 migrations**; [D5](./TECHNICAL_DEBT.md) resolved. [Slice 1 acceptance](../releases/V1_2_SLICE_1_ACCEPTANCE.md). Next: Slice 2 Commit 2c) |
...
| 1.2 | Commercial Intelligence | 🟡 In progress — architecture locked ([Volume 12](./COMMERCIAL_INTELLIGENCE_ARCHITECTURE.md)); **Slice 1 LIVE in production** (1a…1d-3b; serving `9555QJiLxh4O9PrlVp3UH`; D5 resolved; [acceptance](../releases/V1_2_SLICE_1_ACCEPTANCE.md)). **Slice 2: Commits 2a + 2b LIVE** — Property on the shared spine (prod 11 migrations) plus the **2b Property provenance UI + manual-refresh surface, deployed** (build-ID flip verified externally, [D13](./TECHNICAL_DEBT.md) resolved; migration-free). Next: Slice 2 Commit 2c. |
